...
## 2025-02-25 - [High Complexity] **Observation:** `generate_excel` in `src/core/reporting.py` had a Cyclomatic Complexity of 11, handling multiple responsibilities (validation, sheet creation, styling, charting, visualization). **Action:** Refactored into helper methods (`_process_anomaly_sheets`, `_create_anomaly_sheet`, `_add_strategy_sheet`, `_add_visual_insights`), reducing complexity to 2.
