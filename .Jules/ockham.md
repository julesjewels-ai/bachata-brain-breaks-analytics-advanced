...
## 2026-02-20 - [Complex Conditionals] **Observation:** `_estimate_cell_width` in `src/core/reporting.py` had a Cyclomatic Complexity of 8 due to mixed format parsing logic. **Action:** Extracted number formatting logic into `_get_formatted_width` helper, reducing complexity to 4.
