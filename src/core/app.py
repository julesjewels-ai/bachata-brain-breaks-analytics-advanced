...
class BachataAnalyticsApp:
    ...
    """
    def __init__(self, ui: UserInterface, ai_service: AIService, report_generator: ReportGenerator, data_ingestion: DataIngestionService):
    ...
    def ingest_data(self) -> pd.DataFrame:
        ...
        with self.ui.loading("Ingesting channel data..."):
            return self.data_ingestion.fetch_data()
