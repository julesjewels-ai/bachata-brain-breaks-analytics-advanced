...
class BachataAnalyticsApp:
    ...
    """
    def __init__(self, ui: UserInterface, ai_service: AIService, report_generator: ReportGenerator, ingestion_service: DataIngestionService):
    ...
    def ingest_data(self) -> pd.DataFrame:
        ...
        with self.ui.loading("Ingesting channel data..."):
            return self.ingestion_service.ingest_data()
