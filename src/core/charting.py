...
class ChartBuilder:
    ...
    def add_bar_chart(self,
        ...
        # Categories (Labels)
        # Use explicit location if provided, otherwise default to column left of data
        ...
        default_min_row = data_loc.min_row + 1 if data_loc.title_from_data else data_loc.min_row
