...
class ChartBuilder:
    ...
    def add_bar_chart(self,
        ...
        Args:
            ...
            anchor: The cell where the top-left corner of the chart will be
                    placed.
        """
        chart = BarChart()
        ...
        if data_loc.cats_min_col is not None:
            ...
            cats_min_col = data_loc.min_col - 1
