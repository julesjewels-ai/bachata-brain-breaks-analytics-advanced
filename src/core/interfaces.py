...
from src.core.models import AnomalyRecord, NotificationEvent, VideoAnalysisInput
...
class AnomalyRepository(Repository[AnomalyRecord], Protocol):
    """
    Protocol for persisting anomaly records.
    """
