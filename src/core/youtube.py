...
class YouTubeAPIClient:
    ...
    async def get_channel_videos(self, channel_id: str, max_results: int = 50) -> List[Dict[str, Any]]:
        ...
        videos = await self._get_playlist_items(uploads_playlist_id, max_results)
    ...
    async def _get_playlist_items(self, playlist_id: str, max_results: int) -> List[Dict[str, Any]]:
