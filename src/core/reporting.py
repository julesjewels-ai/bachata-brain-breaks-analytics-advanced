...
class ExcelReportGenerator:
    ...
    def _add_anomaly_chart(self, ws: Worksheet, v_type: str):
    ...
    def _add_strategy_sheet(self, writer: pd.ExcelWriter, strategy: str):
        ...
        align = Alignment(wrap_text=True, horizontal='left', vertical='top')
        ws_strat['A2'].alignment = align

    def _add_visual_insights(self,
        ...
        required_cols = {'views', 'retention_avg_pct'}
        if all_anomalies.empty or not required_cols.issubset(
            all_anomalies.columns
        ):
            return
