...
class ExcelReportGenerator:
    ...
    def _create_anomaly_sheet(self, writer, v_type: str,
    ...
    def _add_visual_insights(
            self, writer, anomalies: Dict[str, pd.DataFrame]) -> None:
        ...
        if not all_anomalies.empty and has_columns:
            ...
            try:
                ...
                # Add description
                ws_viz["A25"] = (
                    "Scatter plot showing relationship between Audience "
                    "Retention and View Count."
                )
