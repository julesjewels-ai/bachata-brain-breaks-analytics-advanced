...
class ExcelReportGenerator:
    ...
    def _create_anomaly_sheet(self, writer: pd.ExcelWriter, v_type: str, df: pd.DataFrame) -> None:
        """Creates and styles a sheet for a specific anomaly type."""
    ...
    def _add_strategy_sheet(self, writer: pd.ExcelWriter, strategy: str) -> None:
    ...
    def _add_visual_insights(self, writer: pd.ExcelWriter, anomalies: Dict[str, pd.DataFrame]) -> None:
        """Adds visual insights (charts) to the report."""
