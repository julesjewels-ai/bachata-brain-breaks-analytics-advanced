...
def _initialize_reporting(
    ...
    """Creates the report generation stack with visualization and archival."""
    ...
    anomaly_repo = FileAnomalyRepository("anomalies_archive.jsonl")
    return ArchivalReportGeneratorDecorator(
