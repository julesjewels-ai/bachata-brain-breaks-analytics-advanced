...
from src.core.archival import JSONLRepository, DataArchivalService  # noqa: E402
...
def main() -> None:
    ...
    archival_repo = JSONLRepository[VideoAnalysisInput]("archived_videos.jsonl")
    archival_service = DataArchivalService(archival_repo)
